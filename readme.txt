...
#### 3.2.0 - Apr 7, 2026
- Feature: add Upgrade to Pro upsell on settings page and style plugin row link
- Fix: remove early __() calls in constructors to resolve WP 6.7+ textdomain notice
...
#### 3.0.4 - Apr 1, 2026
- Fix: rewrite SVN deploy to match proven release.sh approach

#### 3.0.3 - Apr 1, 2026
- Fix: remove release-please markers from readme.txt Stable tag
...
- Bump WC tested version up to 9.9.5.

#### 2.4.15 - Jun 19, 2025
- Fix dynamic properties deprecation.
- Bump WC tested version up to 9.9.4.
- Bump WP tested version up to 6.8.1.

#### 2.4.14 - Sep 5, 2024
- Bump WC tested version up to 9.2.3.
- Bump WP tested version up to 6.6.1.
...
- Bump WP tested version up to 6.2.2.
